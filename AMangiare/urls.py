"""
URL configuration for AMangiare project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="APIDoc A'Mangiare",
      default_version='v1',
      description="Documentación de la API de A'Mangiare",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="arturo.sanchez.v2031@gmail.com"),
